...
function DropDown() {
  ...
  return (
    <>
    <div className="relative hidden sm:block text-left group w-2xs hover:bg-[#38059615] mx-1 rounded-4xl ">
      <div className="cursor-pointer buttonContainer flex justify-center items-center flex-row flex-wrap">
        <button className=" cursor-pointer bg-transparent text-[#4B01D4] px-4 py-2 rounded font-bold text-[16px]">
                Browse 
        </button>
        ...
        <ul className="py-1">
          ...
          <li className="relative hover:bg-[#4B01D415] px-4 py-2 cursor-pointer group/option1">
            ...
            <div className="absolute left-full top-[-5px] w-40 bg-white rounded shadow-lg opacity-0 invisible group-hover/option1:visible group-hover/option1:opacity-100 transition duration-200 z-20">
              <ul className="py-1">
                <li className="hover:bg-[#4B01D415] px-4 py-2"><a href={`/online-class?categories=Coding+%26+Tech&grades=1`}>Grade 1</a></li>
                <li className="hover:bg-[#4B01D415] px-4 py-2"><a href={`/online-class?categories=Coding+%26+Tech&grades=2`}>Grade 2</a></li>
                <li className="hover:bg-[#4B01D415] px-4 py-2"><a href={`/online-class?categories=Coding+%26+Tech&grades=3`}>Grade 3</a></li>
              </ul>
            </div>
          </li>
          ...
          <li className="relative hover:bg-[#4B01D415] px-4 py-2 cursor-pointer group/option2">
            ...
            <div className="absolute left-full top-[-45px] w-40 bg-white rounded shadow-lg opacity-0 invisible group-hover/option2:visible group-hover/option2:opacity-100 transition duration-200 z-20">
              <ul className="py-1">
                <li className="hover:bg-[#4B01D415] px-4 py-2"><a href={`/online-class?categories=Math&grades=1`}>Grade 1</a></li>
                <li className="hover:bg-[#4B01D415] px-4 py-2"><a href={`/online-class?categories=Math&grades=2`}>Grade 2</a></li>
                <li className="hover:bg-[#4B01D415] px-4 py-2"><a href={`/online-class?categories=Math&grades=3`}>Grade 3</a></li>
              </ul>
            </div>
          </li>
          ...
          <li className="relative hover:bg-[#4B01D415] px-4 py-2 cursor-pointer group/option3">
            ...
            <div className="absolute left-full top-[-85px] w-40 bg-white rounded shadow-lg opacity-0 invisible group-hover/option3:visible group-hover/option3:opacity-100 transition duration-200 z-20">
              <ul className="py-1">
                <li className="hover:bg-[#4B01D415] px-4 py-2"><a href={`/online-class?categories=Arts&grades=1`}>Grade 1</a></li>
                <li className="hover:bg-[#4B01D415] px-4 py-2"><a href={`/online-class?categories=Arts&grades=2`}>Grade 2</a></li>
                <li className="hover:bg-[#4B01D415] px-4 py-2"><a href={`/online-class?categories=Arts&grades=3`}>Grade 3</a></li>
              </ul>
            </div>
          </li>
        </ul>

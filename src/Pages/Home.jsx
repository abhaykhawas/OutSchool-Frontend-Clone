...
function Home() {
  return (
    <div>
      ...
      <div className='h-[75vh] hero-background'>
        <div className='h-full'>
          <img src="https://outschool.com/_next/static/media/home_hero_top_left.b132f55a.svg" alt="" className='absolute w-10' />
          <img src="https://outschool.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fhome_hero_bottom_left.c207601d.webp&w=256&q=75" alt="" className='absolute bottom-30 left-0'/>
          <HeroSection/>
          <HeroSectionFooter/>
        </div>
      </div>
